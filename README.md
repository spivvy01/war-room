...
<body>
    <div class="cockpit">
        <div class="header"><div style="font-size: 18px; font-weight: bold;">DLTRS V100.0 COMMANDER</div></div>
        <div class="config-panel"><span>ATH:</span><input type="number" id="ath-input" value="29480"><button onclick="updateATH()">LOCK</button></div>
    ...
    <script>
        ...
        function updateMarket() {
            ...
            if (drop <= -4) { plane.className = "plane-img plane-active"; mission.innerText = "B-2 SPIRIT: 已部署"; }
            else { plane.className = "plane-img"; mission.innerText = "空域安全"; }
        }
        updateMarket();
    </script>
</body>
